...
export default class Sbr_3_0_editRerentLineItemModal extends LightningModal {
    @api recordId;
    @api modalHeader;
     ...
     getPOLineItemId(){
        ...
        .then(data => {
            if(data){
                ...
                this.currentUnitCost = this.poLineItemRecord.Unit_Cost__c;
  ...
  */ 
    ...
    handleInputChange(event){
        ...
        if (field === 'orderQuantity') {
            this.poLineItemRecord.Quantity = event.target.value;
        }
        else if (field === 'unit') {
    ...
    async handleSave() {
        ...
        if(allValid){
            ...
            fields[objectFields.quantity.apiName] = this.poLineItemRecord.Quantity;
    ...
    getdata(result){
        ...
        if(result.data){
            ...
            //this.currentUnitCost = data[0].Unit_Cost__c;
