...
export default class Sbr_3_0_orderDeliveryDetailsCmp_PM extends LightningElement {
  @api recordId;
  ...
  wiredRecord(wiredRecordResult) {    //Story#FRONT-8094: Modified the code for refreshview purpose by Gopal Raj
    ...
    if (data) {
      ...
      if (this.objectApiName == "SBQQ__Quote__c") {
        ...
        if(this.dataFields.SBQQ__DeliveryMethod__c.value== "Delivery") {
  ...
  handleSave() {
    ...
    if (this.objectApiName == "SBQQ__Quote__c") {
      ...
      fields[QUOTE_SOURCING_BRANCH.fieldApiName] =
        this.recordDetails.sourcingBranch;
      if (this.recordDetails.deliveryMethod == "Delivery" || this.selectedDeliveryMethod == "Delivery") {
